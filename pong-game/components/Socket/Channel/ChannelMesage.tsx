...
function ChannelMessage(): JSX.Element {
  ...
  const handleReceiveMessage = useCallback(
    ...
    [channelId, channelUserInfo, setChannelLog],
  )

  const handlerReceiveNotice = useCallback(
    (message) => {
      console.log(message)
      if (channelId === message.channelId) {
        setChannelLog({
  ...
  }, [channelId, channelUserInfo, handleReceiveMessage, handlerReceiveNotice])
  return <></>
}
